...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LearnHub Tech — Learn Web Development Fundamentals" },
      { name: "description", content: "Online learning platform for high school and first-year university students. Master HTML, CSS, JavaScript and SQL in one guided course." },
      { name: "author", content: "LearnHub Tech" },
      { property: "og:title", content: "LearnHub Tech — Learn Web Development Fundamentals" },
